...
const CaseManager = () => {
  ...
  async function fetchservice() {
    const data = await fetchApiData(`${Baseurl}/api/v1/Blog/getCaseManager`)
    setData(data?.data);
  }
  async function fetchSingleServices(id) {
    const data = await fetchApiData(`${Baseurl}/api/v1/Blog/getIdCaseManager/${id}`)
  ...
  const handlecreateservice = async(e) => {
    ...
    try {
      await createApiData(
       `${Baseurl}/api/v1/Blog/createCaseManager`,
        formData
      );
 ...
 async  function handledelete(_id) {
    try {
      await deleteApiData(`${Baseurl}/api/v1/Blog/deleteCaseManager/${_id}`);
      setDelete(false)
      fetchservice()
  ...
  const handleEditService = async(e) => {
    ...
    try {
      await updateApiData(
       `${Baseurl}/api/v1/Blog/updateCaseManager/${editItemId}`,
        formData
      );
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[600px] bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 rounded-t">
                  <h3 className="text-xl font-semibold">
                    ...
                    <span className="text-[15px] text-[#525252]">
                      Customize and change/add Manager
                    </span>
                  </h3>
                ...
                <form onSubmit={handlecreateservice}>
                  ...
                  <div className=" justify-center flex mt-4">
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Additional manage Information"
                  ...
                  <div className="mt-4 flex flex-col items-center text-left justify-center">
                    <div className="">Upload Manager image</div>
                ...
                <div >
                  ...
                  <div className=" justify-center flex mt-4">
                    <div>
                      ...
                      <br />
                      <textarea
                        value={info || singleServices?.description}
                        onChange={(e) => setInfo(e.target.value)}
                        placeholder="Additional manage Information"
                        className="placeholder: block w-[533px] h-40 rounded-md border-0 py-1.5 pl-2 pr-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                      />
                  ...
                  <div className="mt-4 flex flex-col items-center text-left justify-center">
                    <div className="">Upload Manage image</div>
                    <div className="bg-[#E6EEFD] h-[150px] w-[533px]  rounded-xl">
                      <div className="p-5 relative rounded-lg h-[200px]">
                        <div className="flex flex-col justify-center text-center mt-3">
                          <label>
        ...
        <div className="flex flex-wrap gap-10 mt-10 ml-10">
          {!!data?.length && data?.map((item) => (
            <div className="cursor-pointer" key={item._id}>
              <div className="box-shadow rounded-lg p-4 relative flex flex-col justify-center items-center">
                <input
                  type="checkbox"
